...
let name11: nameInterface = { lastName: "Flintstone", firstName: "Fred" };         
...
//let name12: nameInterface = { firstName: "Barney", lastName: "Rubble", age: 25 };                   // [TS] Type is not assignabe to type 'nameInterface'
let name12: nameInterface = { firstName: "Barney", lastName: "Rubble", age: 25 } as nameInterface;  // Fixed with a type assertion
displayName("name12", name12);
//let name13: nameInterface = { age: 25 };                                                            // [TS] Type is not assignabe to type 'nameInterface'
//let name13: nameInterface = { age: 25 } as nameInterface;                                           // [TS] Type cannot be converted to type 'nameInterface'
...
let name17: nameInterface2 = { firstName: "Barney", lastName: "Rubble", age: 25 };                  // Fixed with a type assertion
...
let name18: nameInterface3 = { firstName: "Barney", lastName: "Rubble" };                           
displayName("name18", name18);
let name19: nameInterface3 = { firstName: "Barney", lastName: "Rubble", age: 25 };                  
...
let name20: nameInterface4 = { firstName: "Barney", lastName: "Rubble", age: 25, id: 123 };                  
